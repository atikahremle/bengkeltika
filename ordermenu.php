    ...
    ?>
      <form action="./ordermenu.php?id=<?php echo $row['patientID']?>" method="POST" class="form-horizontal">
        ...
        <div role="tabpanel">
  		...
  		<img src= "<?php getMainFoodBF(); ?>" class="img-rounded">
        <?php getMainFoodBF(); ?>
...
function getBevarageBF(){
	...
	$Beverage = $row[mealName];
	echo "<label class='radio-inline'>
    <input type='radio' name='BeverageBF' value='$Beverage'>$Beverage
    </label>";
			}
		}
	}
function getMainFoodBF(){	
	...
	$Food = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FoodBF' value='$Food '>$Food
    </label>";
			}
		}
	}
function getDesertBF(){	
	...
	if($result->num_rows > 0){
	while($row = $result->fetch_array()){
	$Dessert = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='DessertBF' value='$Dessert'>$Dessert
    </label>";
			}
		}
	}
function getFruitBF(){	
	...
	$Fruit = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FruitBF' value='$Fruit'>$Fruit
    </label>";
			}
		}
	}
...
function getBevarageL(){
	...
	$Beverage = $row[mealName];
	echo "<label class='radio-inline'>
    <input type='radio' name='BeverageL' value='$Beverage'>$Beverage
    </label>";
			}
		}
	}
function getMainFoodL(){	
	...
	$Food = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FoodL' value='$Food '>$Food
    </label>";
			}
		}
	}
function getDesertL(){	
	...
	$Dessert = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='DessertL' value='$Dessert'>$Dessert
    </label>";
			}
		}
	}
function getFruitL(){	
	...
	$Fruit = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FruitL' value='$Fruit'>$Fruit
    </label>";
			}
		}
	}
...
function getBevarageD(){
	...
	$Beverage = $row[mealName];
	echo "<label class='radio-inline'>
    <input type='radio' name='BeverageD' value='$Beverage'>$Beverage
    </label>";
			}
		}
	}
function getMainFoodD(){	
	...
	$Food = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FoodD' value='$Food '>$Food
    </label>";
			}
		}
	}
function getDesertD(){	
	...
	$Dessert = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='DessertD' value='$Dessert'>$Dessert
    </label>";
			}
		}
	}
function getFruitD(){	
	...
	$Fruit = $row['mealName'];
	echo "<label class='radio-inline'>
    <input type='radio' name='FruitD' value='$Fruit'>$Fruit
    </label>";
			}
		}
	}
