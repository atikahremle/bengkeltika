    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                    <form action="adminregward.php" method="post" name="formID" id="formID" role="form"> 
                        <div class="form-group">
                            <label for="wardname">Ward Name</label>
                            <input type="text" class="form-control" name="wardname" id="wardname" placeholder="Ward Name">
                        </div>
                        <div class="form-group">
                            <label for="wardnumber">Ward Number</label>
                            <input type="text" class="form-control" name="wardnumber" id="wardnumber" placeholder="Ward Number">
                        </div>
                        <div class="form-group">
