       ...
       <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="admindisease.php"><i class="fa fa-fw fa-cutlery"></i> Disease</a>
                        </li>
                        <li>
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Update Diseases  <small></small>
                            </h1>
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Home > Disease > Update Disease
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <?php
                    $id=$_GET["id"];
                    $sql = $conn->query("SELECT * FROM disease WHERE idDisease = '$id'");                 
                    if($sql->num_rows > 0){
                        while($row = $sql->fetch_assoc()){
                    ?>
        <div class="row">
            <div class="col-md-12">
                <form action="./updatediseases.php" method="POST" class="form-horizontal">
                  <div class="form-group">
                      <label for="name" class="col-sm-2 control-label">Disease Name</label>
                      <div class="col-sm-5">
                          <input type="text" name="dname" class="form-control" id="name" value="<?=$row['dName']?>" placeholder="Example: Athma">
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="severity" class="col-sm-2 control-label">Disease Severity</label>
                      <div class="col-sm-5">
                          <input type="text" name="dseverity" class="form-control" id="severity" value="<?=$row['dSeverity']?>" placeholder="Example: A">
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="details" class="col-sm-2 control-label">Disease Details</label>
                      <div class="col-sm-5">
                            <textarea name="ddetails" class="form-control" id="details" placeholder="Example: This disease..."><?=$row['dDetails']?></textarea>
                      </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                    <input type="hidden" name="id" value="<?=$row['idDisease']?>">
